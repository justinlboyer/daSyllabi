...
\subparagraph*{What parents can do to help:}

Ask students about their homework assignment and see how they felt about it.

Assignments are given on a daily basis with the exception of sometimes on test days. If you aren’t seeing homework being done at home, ask them about their assignment and have them show it to you. If you are curious about if assignments have been turned in, check canvas and/or contact me via email.

If they are stuck on a particular problem, ask them to tell/show you from the beginning what they did. Often times in explaining it to someone else students will find out what they did wrong.

If a particular problem is taking a long time, stop doing the problem and ask about it in class.

If students are continually taking longer to do assignments, please contact me so we can use additional resources to get them to where they are successful in completing the homework in 30 min or less.
